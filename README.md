...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create somm-fe-2f72
  fly create somm-fe-2f72-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app somm-fe-2f72
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app somm-fe-2f72-staging
  ```
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name somm-fe-2f72-db
  fly postgres attach --postgres-app somm-fe-2f72-db --app somm-fe-2f72

  fly postgres create --name somm-fe-2f72-staging-db
  fly postgres attach --postgres-app somm-fe-2f72-staging-db --app somm-fe-2f72-staging
  ```
